...
func (m *MockStorage) GetTextValues(arg0 context.Context, arg1 string, arg2 uint) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) GetValue(arg0 context.Context, arg1 string, arg2, arg3 uint) ([]byte, error) {
	m.ctrl.T.Helper()
